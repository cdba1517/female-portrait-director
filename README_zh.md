...
女性人像提示词导演 Skill 是一个面向 AI 生图场景的结构化女性人像提示词生成与视觉扩写系统，支持清纯生活照、纯欲曲线生活照、都市时尚写真、古风仙侠美人图、电商服装模特图等多种风格。V1.1 创作扩写增强版会锁定用户参数，理解视觉意图，扩写各个摄影模块，再融合为稳定、合规、可复制的 AI 图像提示词。
...
- 作者：李岳
- 版本：`FEMALE-PORTRAIT-DIRECTOR-V1.1`
